...
namespace BrightStarSample 
{
    public partial class MyEntityContext : BrightstarEntityContext {
        ...
        public static void InitializeEntityMappingStore()
        {
    		...
    		provider.AddMappingsForType(EntityMappingStore.Instance, typeof(BrightStarSample.IPerson));
    		EntityMappingStore.Instance.SetImplMapping<BrightStarSample.IPerson, BrightStarSample.Person>();
    	}
    	...
    	{
    		Persons = 	new BrightstarEntitySet<BrightStarSample.IPerson>(this);
    	}
    	
    	public IEntitySet<BrightStarSample.IPerson> Persons
    	{
    		get; private set;
    	}
        ...
        public IEntitySet<T> EntitySet<T>() where T : class {
            ...
            if (typeof(T).Equals(typeof(BrightStarSample.IPerson))) {
...
namespace BrightStarSample 
{
    ...
    public partial class Person : BrightstarEntityObject, IPerson 
    {
    	...
    	#region Implementation of BrightStarSample.IPerson
    
    	public System.Int32 PersonAge
    	{
            		get { return GetRelatedProperty<System.Int32>("PersonAge"); }
            		set { SetRelatedProperty("PersonAge", value); }
    	}
    
    	public System.String PersonName
    	{
            		get { return GetRelatedProperty<System.String>("PersonName"); }
            		set { SetRelatedProperty("PersonName", value); }
    	}
    	#endregion
    }
}
